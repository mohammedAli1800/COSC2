...
class Manager_model extends CI_Model {
    ...
    public function load($id = FALSE) {
        ...
        $query = $this->db->get_where('tbl_manager', array('manager_id' => $id));
        return $query->row_array();
    }
    ...
    public function getall() {
        ...
        $sql = "SELECT * from tbl_manager as m,tbl_country as c,tbl_state as s,tbl_city as c1 where m.manager_country=c.c_id and m.manager_state=s.s_id and m.manager_city=c1.c_id";
        $query = $this->db->query($sql);
        return $query->result_array();
    }
    ...
    public function delete($id) {
        ...
        return $this->db->delete('tbl_manager');
    }
