            ...
            <div class="col-md-12">
                ...
                <div class="box box-info"> 
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Manager Form</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" method="post" action="<?php echo base_url('manager/insert/'); ?>" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <label>Username</label>
                                    <div class="form-group">
                                        <input tabindex="1" required type="text" name="manager_name" onchange="return finddata();" placeholder="Enter User Name" id="name" class="form-control"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Password</label>
                                        <input tabindex="3" required type="password" name="manager_password" placeholder="Enter Password" id="password" class="form-control"/>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input tabindex="2" required type="email" name="manager_email" placeholder="Enter Email Address" id="email" class="form-control"/>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input tabindex="4"  maxlength="10" required type="text" name="manager_phone" pattern="\d{10}" title="Please Enter !0 Digit Valid Mobile No" onkeypress='return (event.which >= 48 && event.which <= 57)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right" name="manager_dob" id="datepicker">
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    function finddata() {
        ...
        $.ajax({
            ...
            data: dataString,
            cache: false,
            url: "<?php echo base_url(); ?>index.php/manager/finddata",
            success: function (result) {
              if(result!=""){
                  
                  window.location="<?php echo base_url('manager/edit/'); ?>"+result;
              }
            }
        });
    }
