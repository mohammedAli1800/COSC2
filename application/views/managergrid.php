            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Manager Grid</h3>

                        <h3 style="float:right;">
                            <a href="<?php echo base_url('manager/add/'); ?>" class="btn btn-warning pull-right">Add Manager</a>
                        </h3>
                    </div>
                    <!-- /.box-header -->
                    <style>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($manager as $manager_item) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $i; ?></td>
                                        <td><?php echo $manager_item['manager_name']; ?></td>
                                        <td><?php echo $manager_item['manager_phone']; ?></td>
                                        <td><?php echo $manager_item['manager_email']; ?></td>
                                        <td><?php echo $manager_item['manager_password']; ?></td>
                                        <td><?php echo $manager_item['manager_dob']; ?></td>
                                        <td><?php echo $manager_item['country_name']; ?></td>
                                        <td><?php echo $manager_item['state_name']; ?></td>
                                        <td><?php echo $manager_item['city_name']; ?></td>
                                        
                                        <td class="center">
                                            <a class="btn btn-primary" href="<?php echo base_url('manager/edit/' . $manager_item['manager_id']); ?>"><i class="fa fa-pencil fa-fw"></i></a>&nbsp;&nbsp;&nbsp;
                                            <a class="btn btn-success" href="<?php echo base_url('manager/delete/' . $manager_item['manager_id']); ?>" onclick="return confirm('Are you sure want to delete this?');"><i class="fa fa-times fa-fw"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php } ?>
